...
public class MobileChngPass2 extends HttpServlet
{
	...
	throws ServletException,IOException
	{
		...
		out.println("<html>");
		out.println("<head><title>N4E-Mobile - Change User Password</title></head>");
		...
		try
		{
			...
			int update=stmt.executeUpdate("update MobileUsers set Password='"+newpasswd+"' where UserName='"+username+"' AND Password='"+passwd+"'");
			if(update==0){
			...
			out.println("<p align='center'><strong><a href='../mobile/user.html'>Click Here</a> to Login Again!</strong></p></body></html>");			
			}
		    catch(Exception e){
			try{
